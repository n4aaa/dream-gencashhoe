...
public class PluginConfig extends OkaeriConfig {
    ...
    @Comment("Skonfiguruj item w edytorze opisu:")
    @CustomKey(value="icon-lore-menu-template")
    public ItemStack iconLoreMenuTemplate = ItemBuilder.of(XMaterial.PAPER.parseMaterial())
    ...
    public ItemStack iconEnchantMenuTemplate = ItemBuilder.of(XMaterial.ENCHANTED_BOOK.parseMaterial())
    ...
    public ItemStack iconBreakablesMenuTemplate = ItemBuilder.of(XMaterial.DIRT.parseMaterial())
    ...
    public ItemStack templateHoeItemStack = ItemBuilder.of(XMaterial.NETHERITE_HOE.parseMaterial()).setName("&6&lMotyka {size}x{size}").setLore(Arrays.asList("", "&8» &7Ta motyka kopie: &f{size}x{size}")).addEnchant(Enchantment.DURABILITY, 4).toItemStack();
    ...
    public List<HoeItem> hoes = Arrays.asList(
            new HoeItem(
                    1,
                    ItemBuilder.of(XMaterial.NETHERITE_HOE.parseMaterial()).setName("&6&lMotyka 2x2").addEnchant(Enchantment.DURABILITY, 4).toItemStack(),
                    true,
                    2,
                    Arrays.asList()
            )
